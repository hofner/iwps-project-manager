...
@Entity
@Table(name = "assisting_customer_project_manager", uniqueConstraints = {
      @UniqueConstraint(columnNames = { "signum", "fullname" }) })
public class AssistingCustomerProjectManager extends AbstractAuditableEntity {
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AssistingCustomerProjectManager other = (AssistingCustomerProjectManager) obj;
    if (fullName == null) {
